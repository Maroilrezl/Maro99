...
if (!text) throw `*[❗خطاء❗] مثال علي الامر ${usedPrefix + command} مارو┇✦*`
...
let link = image
conn.sendFile(m.chat, link, 'error.jpg', `🔎 *النتيجه لـ:* ${text}\n🔗 https://whatsapp.com/channel/0029Vacc9DXEAKWIWX8nQu1T, m)}
